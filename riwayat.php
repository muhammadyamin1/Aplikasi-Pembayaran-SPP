...
$no = 1;
$data = mysqli_query($koneksi, "SELECT petugas.nama_petugas,siswa.nama,pembayaran.tgl_bayar,pembayaran.bulan_dibayar,pembayaran.tahun_dibayar,pembayaran.jumlah_bayar,pembayaran.status FROM pembayaran LEFT JOIN petugas ON pembayaran.id_petugas=petugas.id_petugas LEFT JOIN spp ON pembayaran.id_spp=spp.id_spp LEFT JOIN siswa ON pembayaran.nisn=siswa.nisn ORDER BY id_pembayaran DESC");
?>
