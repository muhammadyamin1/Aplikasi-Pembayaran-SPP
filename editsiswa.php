...
if (isset($_POST['btnSubmit'])) {
    ...
    if ($nisErr == '' && $namaErr == '' && $kelasErr == '' && $alamatErr == '' && $sppErr == '' && $fotoErr == '') {
        $result = mysqli_query($koneksi, "update siswa set nis = '$nis', nama = '$nama', id_kelas = '$kelas', alamat = '$alamat', no_telp = '$hp', id_spp = '$spp', photo = '$foto' where nisn = '$idget'");
        if (!$result) {
    ...
    $idget = $_GET['id'];
    $query = mysqli_query($koneksi, "select * from siswa where nisn = '$idget'");
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $idget); ?>" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="nisn" type="text" class="form-control" disabled="disabled" value="<?php echo $nisn ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img class="mb-1" style="max-width: 200px" id="blah" src="Foto/siswa/<?php echo $foto ?>" alt="your image" />
